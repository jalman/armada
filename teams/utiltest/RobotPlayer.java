...
public class RobotPlayer {
  ...
  public static void run(RobotController rc) {
    ...
    if (rc.getType() == RobotType.SOLDIER) {
       ...
       * System.out
       * .println(
       * "tiles traversable 1 [if statement] precompute tile, no out-of-bounds, two array accesses: "
       * + t);
       * countBytecodes(true);
       * rc.yield();
       * t = 0;
       ...
       * System.out
       * .println(
       * "tiles traversable 1 [if statement] precompute tile, no out-of-bounds,  one store one array access: "
       * + t);
       * countBytecodes(true);
       * rc.yield();
       * t = 0;
       ...
       * for (x = 9; x >= 0; --x) {
       * for (y = 9; y >= 0; --y) {
       * if (rc.senseTerrainTile(new MapLocation(x, y))
       ...
       * }
       * System.out
       * .println("tiles traversable 3 [isTraversable] use senseCachedTerrainTile full cache: "
       * + t);
       * countBytecodes(true);
       * rc.yield();
       */
  ...
  /*
   * public static final int[] SQRTS = {0, 1, 1, 1, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 4, 4, 4, 4,
   * 4,
   ...
   * 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60,
   * 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60};
   * public static final int[] SQUARES = {0, 1, 4, 9, 16, 25, 36, 49, 64, 81, 100, 121, 144, 169,
   * 196,
